 ...
 * All rights reserved.
 */
package com.netcracker.solutions.etisalat.rvcpe.portal.hook.login.server.utils;
...
public class TokenUtil {
    ...
    public static SoParams getSoParams(String token) throws IllegalStateException {
        ...
        return new SoParams(login, host, port);
    }
