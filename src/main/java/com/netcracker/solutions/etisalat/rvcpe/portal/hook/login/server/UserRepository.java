...
public class UserRepository {
    ...
    private static String query = "/so/api/v1/customers/";
    private static String hostPrefix = "http://";

    public User getUser(SoParams params) throws ResourceAccessException, HttpClientErrorException {
        String request = hostPrefix + params.getHost() + ":" + params.getPort() + query + params.getLogin();
